...
if (isset($_SESSION['first_name']) && isset($_SESSION['last_name']) && isset($_SESSION['email']) 
  ...
  if ( ($fn=='') || ($ln=='') || ($em=='') || ($he=='') || ($su=='') ) {
    ...
    $stmt = $pdo->prepare('UPDATE Profile SET user_id = :ui, first_name=:fn, last_name=:ln, email=:em, headline=:em, summary=:su WHERE profile_id=:id');
...
<p>Summary:<br/><textarea name="summary" rows="8" cols="80"><? echo $row['summary']; ?></textarea>
